...
@section('content')
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Withdraw Points {{ $user->name }}</h3>
		...
		<div class="box-body">
			...
			<form id="withdrawForm" class="fpms" method="POST"
				  action="{{ route('admin.points.update.withdraw',$user->id) }}" autocomplete="off">
				@csrf
		...
		<div class="box-footer">
			<button id="withdrawSubmit" type="submit" class="btn btn-primary bpms">
				Withdraw
			</button>
		</div>
	</div>
