<ul class="dropdown-menu">
    ...
    @else
        <li>
            <ul class="menu">
                @foreach($notify as $notification)
                    <li>
                        <a href="{{ route('teacher.notify.read',['id' => $notification->notify_id ,'title' => $notification->notify->title]) }}">
        ...
        <li class="footer"><a href="{{ route('teacher.notify.viewAll') }}">View all</a></li>
    @endif
</ul>